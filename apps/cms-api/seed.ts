...
await prisma.portfolio.create({
  ...
  await prisma.contactSettings.create({
    data: {
      title: { az: 'Bizimlə əlaqə', en: 'Contact Us', ru: 'Свяжитесь с нами' },
      description: {
      ...
      locationLabel: { az: 'Ünvan', en: 'Location', ru: 'Адрес' },
      locationValue: { az: 'Bakı, Azərbaycan', en: 'Baku, Azerbaijan', ru: 'Баку, Азербайджан' },
      hoursLabel: { az: 'İş saatları', en: 'Working Hours', ru: 'Рабочие часы' },
      hoursValue: {
        az: 'B.e - Cümə: 09:00 - 18:00',
        en: 'Mon - Fri: 09:00 - 18:00',
        ru: 'Пн - Пт: 09:00 - 18:00',
      },
      followUsLabel: { az: 'Bizi izləyin', en: 'Follow Us', ru: 'Следите за нами' },
      tags: ['web', 'design', 'development'],
      image: '/uploads/contact-image.jpg',
      imageAlt: { az: 'Əlaqə şəkli', en: 'Contact image', ru: 'Изображение контакта' },
      formNameLabel: { az: 'Ad', en: 'Name', ru: 'Имя' },
      formNamePlaceholder: { az: 'Adınız', en: 'Your name', ru: 'Ваше имя' },
      formEmailLabel: { az: 'Email', en: 'Email', ru: 'Почта' },
      formEmailPlaceholder: { az: 'emailiniz@mail.com', en: 'your@email.com', ru: 'ваш@email.com' },
      formPhoneLabel: { az: 'Telefon', en: 'Phone', ru: 'Телефон' },
      formPhonePlaceholder: { az: '+994 XX XXX XX XX', en: '+994 XX XXX XX XX', ru: '+994 XX XXX XX XX' },
      formServiceLabel: { az: 'Xidmət', en: 'Service', ru: 'Услуга' },
      formBudgetLabel: { az: 'Büdcə', en: 'Budget', ru: 'Бюджет' },
      formBudgetPlaceholder: { az: 'Büdcənizi seçin', en: 'Select your budget', ru: 'Выберите бюджет' },
      formTimelineLabel: { az: 'Müddət', en: 'Timeline', ru: 'Сроки' },
      formTimelinePlaceholder: { az: 'Müddəti seçin', en: 'Select timeline', ru: 'Выберите срок' },
      formMessageLabel: { az: 'Mesaj', en: 'Message', ru: 'Сообщение' },
      formMessagePlaceholder: { az: 'Mesajınızı yazın...', en: 'Write your message...', ru: 'Напишите сообщение...' },
      formSubmitLabel: { az: 'Göndər', en: 'Send Message', ru: 'Отправить' },
      socialLinks: {
        create: [
          { icon: '/uploads/instagram.svg', href: 'https://instagram.com', order: 1 },
          { icon: '/uploads/linkedin.svg', href: 'https://linkedin.com', order: 2 },
      ...
      budgetOptions: {
        create: [
          { label: { az: '$1,000 - $5,000', en: '$1,000 - $5,000', ru: '$1,000 - $5,000' }, order: 1 },
          { label: { az: '$5,000 - $10,000', en: '$5,000 - $10,000', ru: '$5,000 - $10,000' }, order: 2 },
          { label: { az: '$10,000+', en: '$10,000+', ru: '$10,000+' }, order: 3 },
        ],
      },
      timelineOptions: {
        create: [
          { label: { az: '1-3 ay', en: '1-3 months', ru: '1-3 месяца' }, order: 1 },
          { label: { az: '3-6 ay', en: '3-6 months', ru: '3-6 месяцев' }, order: 2 },
          { label: { az: '6+ ay', en: '6+ months', ru: '6+ месяцев' }, order: 3 },
        ],
      },
    },
  });
