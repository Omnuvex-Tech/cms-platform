...
async function main() {
  ...
  // PORTFOLIO SETTINGS
  // ─────────────────────────────────────────
  if ((await prisma.portfolioSettings.count()) === 0) {
  ...
  // ─────────────────────────────────────────
  if ((await prisma.partnerSection.count()) === 0) {
  ...
  // BLOG SETTINGS
  // ─────────────────────────────────────────
  if ((await prisma.blogSettings.count()) === 0) {
  ...
  if ((await prisma.ourTeamSettings.count()) === 0) {
  ...
  if ((await prisma.aboutSettings.count()) === 0) {
